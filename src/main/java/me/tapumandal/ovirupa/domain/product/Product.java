...
//        this.setImage(productDto.getImage());
        ...
        this.setColor(productDto.getColor());
        this.setVariableProductName(productDto.getVariableProductName());
        this.setVariableProductPrice(productDto.getVariableProductPrice());

        this.setMetaTagTitle(productDto.getMetaTagTitle());
        this.setMetaTagDescription(productDto.getMetaTagDescription());

        this.setTitle(productDto.getTitle());
        this.setBlog(productDto.getBlog());
    }

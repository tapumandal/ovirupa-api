...
import me.tapumandal.ovirupa.domain.payment_gateway.Utility.Util;
import me.tapumandal.ovirupa.domain.payment_gateway.parametermappings.SSLCommerzInitResponse;
...
//             this.storePass = "qwerty";
    ...
    boolean orderValidate(String merchantTrnxnId, String merchantTrnxnAmount, String merchantTrnxnCurrency,
        ...
        if (hash_verified) {
            ...
            //GET Request
            String validUrl = this.sslczURL + this.validationURL + "?val_id=" + EncodedValID + "&store_id=" + EncodedStoreID + "&store_passwd=" + EncodedStorePassword + "&v=1&format=json";

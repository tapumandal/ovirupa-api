package me.tapumandal.ovirupa.domain.payment_gateway.parametermappings;
...
public class SSLCommerzValidatorResponse {
    ...
    public String getVerify_sign() {
        return verify_sign == null ? "" : verify_sign;
    }
    ...
    public String getVerify_key() {
        return verify_key == null ? "" : verify_key;
    }
